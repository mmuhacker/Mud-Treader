...
- [حاسبة تحويل العملات](#حاسبة-تحويل-العملات)
...
```bash
cd ~ && curl -o mud_tr.py https://raw.githubusercontent.com/mmuhacker/Mud-Treader/main/mud_tr.py && chmod +x mud_tr.py && sudo ln -sf ~/mud_tr.py /usr/local/bin/tr && echo "تم تحديث Mud-Treader (tr) بنجاح!"
```
---
...
```bash
sudo apt update && sudo apt upgrade -y && sudo apt install python3 python3-pip beep -y && pip3 install websocket-client rich arabic-reshaper python-bidi --break-system-packages && cd ~ && curl -o mud_tr.py https://raw.githubusercontent.com/mmuhacker/Mud-Treader/main/mud_tr.py && chmod +x mud_tr.py && sudo ln -sf ~/mud_tr.py /usr/local/bin/tr && echo "تم تثبيت Mud-Treader (tr) بنجاح على Kali Linux!"
```
---
...
- ✅ 3 محاولات إدخال فقط
- ✅ مفتاح الترخيص ممكن يعمل على جهاز واحد فقط، أو بحسب الإختيار 
...
---
<div align="center" id="حاسبة-تحويل-العملات">
...
### طريقة الاستخدام:
1. اختر `[3]` من القائمة الرئيسية
2. أدخل العملة المصدر (مثال: USD)
3. أدخل العملة الهدف (مثال: JOD)
4. أدخل المبلغ المراد تحويله
...
⚠️ **تنبيه:**
**التداول ينطوي على مخاطر عالية. لا تستثمر أكثر مما تستطيع تحمل خسارته. هذه الأداة لأغراض تعليمية فقط.**
...
<div align="center" id="صور-للبوت">
  ...
  <img src="images/07.png" width="45%" style="border-radius: 20px; border: 2px solid var(--color-border-default); margin: 5px;">
  <img src="images/08.png" width="45%" style="border-radius: 20px; border: 2px solid var(--color-border-default); margin: 5px;">
  <img src="images/09.png" width="45%" style="border-radius: 20px; border: 2px solid var(--color-border-default); margin: 5px;">
  <img src="images/10.png" width="45%" style="border-radius: 20px; border: 2px solid var(--color-border-default); margin: 5px;">
  <img src="images/11.png" width="45%" style="border-radius: 20px; border: 2px solid var(--color-border-default); margin: 5px;">
