...
|4| 📊 **قوة الإشارة** | 4 مستويات (65%-80%) |
|5| 🔊 **التنبيهات** | صوتية للإشارات والأرباح والخسائر |
|6| 📰 **الأخبار** | تحديثات مباشرة للسوق |
|7| ⏱ **الفريمات** | 5 أطر زمنية (1د - 60د) |
|8| 🔒 **الترخيص** | نظام متكامل يعمل بدون إنترنت |
|9| 🎨 **الواجهة** | عربية بالكامل مع ألوان احترافية |
|10| 📊 **اللوحة** | شاشة تحكم متكاملة في الوقت الفعلي |
|11| 💾 **الحفظ** | تلقائي للإعدادات والتوكنات |
|12| 🖥️ **البيئة** | Termux (Android) + Kali Linux |
