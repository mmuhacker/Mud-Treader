...
- [التثبيت](https://github.com/mmuhacker/mud-ps/blob/main/README.md#%EF%B8%8F-%D8%A7%D9%84%D8%AA%D8%AB%D8%A8%D9%8A%D8%AA)
...
- 🎯 **5 استراتيجيات تحليلية** (RSI+MA, MACD, Bollinger Bands, دعم/مقاومة, مجمّع)
- 📊 **4 مستويات لقوة الإشارة** (65% إلى 80%)
- 🔊 **تنبيهات صوتية ذكية** للإشارات الجديدة والأرباح والخسائر
- 📰 **أخبار السوق المباشرة** في لوحة التحكم
- ⏱ **5 أطر زمنية** (1 دقيقة إلى ساعة)
- 🔒 **نظام ترخيص متكامل** يعمل بدون إنترنت بعد أول تفعيل
- 🎨 **واجهة عربية بالكامل** مع ألوان احترافية
- 📈 **لوحة تحكم متكاملة** تعرض جميع المؤشرات والصفقات في الوقت الفعلي
- 💾 **حفظ الإعدادات** تلقائياً (توكنات، عملة، استراتيجية...)
...
|#|المكتبة|الوصف|
|---|------|-------|
|1|Python 3.8+|لغة البرمجة الأساسية|
